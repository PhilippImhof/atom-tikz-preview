  ...
  fetchText() {
    ...
    for (let i = start; i >= 0; i--) {
      ...
      if (curLine.includes("\\begin{tikzpicture}")) {
        start = i;
        break;
      } else if (curLine.includes("\\end{tikzpicture}") || curLine.includes("\\begin{document}")) {
        return null;
        break;
      }
    }
    ...
    for (let i = end; i < lineCount; i++) {
      ...
      if (curLine.includes("\\end{tikzpicture}")) {
        ...
        break;
      } else if (curLine.includes("\\begin{tikzpicture}") || curLine.includes("\\end{document}")) {
        return null;
        break;
      }
    }
